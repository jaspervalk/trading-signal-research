...
export default function LeaderboardPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Creator leaderboard</h1>
        <p className="text-sm text-[var(--muted-foreground)] mt-1">
          Multi-metric scorecards with Wilson 95% CIs. N matters more than any rate — small N collapses every metric to noise.
        </p>
      </div>
